...
<h1>您随机的灯光指令是____<span id="y1">_____</span></h1>

   </label>
 
 
 
<h1>您随机的灯光指令是____<span id="y2">_____</span></h1>
...
 
 
<h1>您随机的灯光指令是____<span id="y3">_____</span></h1>
...
   
   
<h1>您随机的灯光指令是____<span id="y4">_____</span></h1>
...
 
<h1>您随机的灯光指令是____<span id="y5">_____</span></h1>
...
<h1>您随机的灯光指令是____<span id="spanId2">_____</span></h1>
...
<h1>您随机的灯光指令是____<span id="spanId3">_____</span></h1>
...
var y2="+";
                ...
                $("#"+xy).text(arr.join(",")+y2+y3+xy2+yy2);
...
var y2="+";
                ...
                $("#"+xyz).text(arr.join(",")+y2+yy+y3+xy2+yy2);
